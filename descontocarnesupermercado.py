# Determinar preço das carnes e desconto no cartão
...
pagamento = input("Dinheiro ou cartão hipercard (5% de desconto)? D ou C: ")
preco_total = 0

print("\nHipermercado tudocaro\nCupom fiscal\n")
...
if pagamento == "D" or pagamento == "d":
    ...
    print("Tipo de pagamento: Cartão Hipercard")
